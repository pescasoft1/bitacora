(ns bitacora.hooks.servicios_vehiculo
  "Business logic hooks for servicios_vehiculo entity.
...
(defn before-load
  ...
  (println "[INFO] Loading servicios_vehiculo with params:" params)
  params)
...
(defn after-save
  ...
  (println "[INFO] Servicios_vehiculo saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if servicios_vehiculo can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Servicios_vehiculo deleted successfully. ID:" entity-id)
  {:success true})
