(ns bitacora.hooks.vehiculos
  "Business logic hooks for vehiculos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading vehiculos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "vehiculos record(s)")
...
(defn after-save
  ...
  (println "[INFO] Vehiculos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if vehiculos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Vehiculos deleted successfully. ID:" entity-id)
  {:success true})
