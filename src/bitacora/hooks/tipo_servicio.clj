(ns bitacora.hooks.tipo_servicio
  "Business logic hooks for tipo_servicio entity.
...
(defn before-load
  ...
  (println "[INFO] Loading tipo_servicio with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "tipo_servicio record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving tipo_servicio...")
...
(defn after-save
  ...
  (println "[INFO] Tipo_servicio saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if tipo_servicio can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Tipo_servicio deleted successfully. ID:" entity-id)
  {:success true})
