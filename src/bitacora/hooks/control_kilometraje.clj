(ns bitacora.hooks.control_kilometraje
  "Business logic hooks for control_kilometraje entity.
...
(defn before-load
  ...
  (println "[INFO] Loading control_kilometraje with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "control_kilometraje record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving control_kilometraje...")
...
(defn after-save
  ...
  (println "[INFO] Control_kilometraje saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if control_kilometraje can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Control_kilometraje deleted successfully. ID:" entity-id)
  {:success true})
