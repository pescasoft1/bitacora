(ns bitacora.hooks.conductores
  "Business logic hooks for conductores entity.
...
(defn before-load
  ...
  (println "[INFO] Loading conductores with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "conductores record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving conductores...")
...
(defn after-save
  ...
  (println "[INFO] Conductores saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if conductores can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Conductores deleted successfully. ID:" entity-id)
  {:success true})
