(ns bitacora.core
  (:require
   ...
   [bitacora.models.crud :refer [config KEY]]
   [bitacora.routes.proutes :refer [proutes]]
   [bitacora.routes.routes :refer [open-routes password-routes]]
   [bitacora.routes.i18n :refer [i18n-routes]]
   [bitacora.routes.tabgrid :refer [tabgrid-routes]]
