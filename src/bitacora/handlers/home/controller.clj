(ns bitacora.handlers.home.controller
  (:require
   [buddy.hashers :as hashers]
   [clojure.string :as st]
   [bitacora.config.loader :as cfg]
   [bitacora.i18n.core :as i18n]
   [bitacora.handlers.home.model :refer [get-user get-users update-password]]
   [bitacora.handlers.home.view :refer [change-password-view forgot-password-view home-view main-view
                                    temp-password-view]]
   [bitacora.layout :refer [application]]
   [bitacora.models.email :as email]
   [bitacora.models.util :refer [get-session-id user-auth]]
