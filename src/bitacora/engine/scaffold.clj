...
(defn generate-hook-stub
  ...
  (let [file-fields (filter #(= :file (:type %)) fields)
    ...
    (str "(ns bitacora.hooks." entity-name "\n"
...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :bitacora.hooks." entity-name "/before-load\n"
         " ;;         :after-load :bitacora.hooks." entity-name "/after-load\n"
         " ;;         :before-save :bitacora.hooks." entity-name "/before-save\n"
         " ;;         :after-save :bitacora.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :bitacora.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :bitacora.hooks." entity-name "/after-delete}\n"
